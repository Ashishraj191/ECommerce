...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#">Ucchal Ads</a>
    </div>
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="active"><a href="collection_Amt.php"><center><i class="fa fa-money"> Collection</i></center></a></li>
        </li>
        <li class="dropdown">
  ...
  <div class="row content">
    ...
    <div class="col-sm-12 text-left"> 
      <nav class="navbar navbar-default ">
          <div class="container-fluid">
            <ul class="nav navbar-nav">
              <li><a href="#" id="view">View Collection</a></li> 
            </ul>
            <!-- <ul class="nav navbar-nav navbar-right">
...
<script type="text/javascript">
    $(function(){
         $.get("collection_Amt_c.php",function(data){
            $("#viewing").html(data);
         });
      });
      $("#search").keyup(function(){
              var search = $("#search").val();
              $.get("collection_Amt_c.php",{search:search},function(data){
                $("#viewing").html(data);
             });
          });

            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="active"><a href="manage_distributor.php"><center><i class="fa fa-user"></i> Manage Distributor</i></center></a></li>
            ...
            <div class="row content">
                ...
                <div class="col-sm-12 text-left">
                    <nav class="navbar navbar-default ">
                        <div class="container-fluid">
                            <ul class="nav navbar-nav">
                                <li><a href="#" id="view">View Distributer</a></li>
                                <!-- <li><a href="#" id="add">Add Distributer</a></li> -->
                            </ul>
                            <!-- <ul class="nav navbar-nav navbar-right">
                            ...
                            <form class="navbar-form navbar-right">
                                <div class="form-group col-sm-1" >
                                    <input type="text" class="form-control" id="search" width="" placeholder="Search">
                                </div>
                            </form>
                        </div>
                    </nav>
                    <div class="container" id="adding">
                        <h3>Add Distributer</h3>
                    </div>
                </div>
...
<script type="text/javascript">
     ...
     $(function(){
         $.get("manage_distributor_c.php",function(data){
            $("#viewing").html(data);
         });
      });
      $("#search").keyup(function(){
              var search = $("#search").val();
              $.get("manage_distributor_c.php",{search:search},function(data){
                $("#viewing").html(data);
             });
          });
...
<script type="text/javascript">
    $("#name, #email, #mobile, #pass, #city, #state, #address").keyup(function(){
    $("#alert").hide();
});
